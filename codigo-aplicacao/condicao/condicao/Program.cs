    ...
    class Program
    {
        ...
        { /*
            ...
            if (numero > 5)
            {
                ...
                if (numero % 2 == 0)  //é possível colocar quantos ifs vc quiser, desde a sua necessidade. Caso eu queira colocar mais especificações a partir dessa já especificação.
                {
            ...
            */
            ...
            int numero = 12;
            string mensagem = "";
            mensagem = numero > 5 ? "Maior que 5" : "Menor que 5"; //condição ? true : false ;
