...
namespace basico
{
    ...
    {
        public static void operadoresteste()
        {
            ...
            int num1 = 15;
            int num2 = 54;
            int resultado3 = num1 + num2; // resultado é apenas uma variável e não um código para fazer o procedimento matemático.
            Console.WriteLine(resultado);
            //ou
            int num3 = 15;  // prefira esse pois com esse você pode fazer outras operações com os mesmos números sem precisar copiar muito.
            int num4 = 54;
            ...
            double num5 = 152;
            double num6 = 21; //primeiro o parênteses depois a multiplicação e divisão(caso tenha duas ou mais sem parênteses , a prioridade será da esquerda para direita e depois subração e soma.
            double num7 = 12;
            double res = (num5 + num6) * num7 / 3;
            ...
            Console.WriteLine(num11); //irá exibir o 11

            int num10 = 44;
            Console.WriteLine(num10++); //num7++ ele usa o valor atual e depois incrementa, ou seja, só no segundo console ele aplicará o operador para somar o valor.
            ...
            int numero1 = 215;
            string numero2 = "100";
            string resultado4 = numero1 + numero2;
